...
<img src="../assets/mobile_login.png" alt="Login Hi5" style="max-width:150px">
...
![Hi5 Soma-pinpointing UI](../assets/mobile_soma_pinpointing_ui.png)
...
Press ">" to switch to next file and a new file will be preloaded.
